...
import {IPropsDaily} from '../types'
 ...
 const DisplayDailyWeather: React.FC = () => {
	const {daily: dailyWeather} = useSelector((state: RootState) => state.weather);
	return (
		<Container sx={{gridArea: 'daily'}}>
			<Heading sx={{marginBottom: '10px', fontSize: [3, 4, 5]}}>Seven Day Forecast</Heading>
